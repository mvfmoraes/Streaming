...
GROUP_CONCAT(DISTINCT CONCAT(c.name, ': ',
		(SELECT GROUP_CONCAT(f.title ORDER BY f.title SEPARATOR ', ')
                    FROM streaming.film f
                    INNER JOIN streaming.film_category fc
                      ON f.film_id = fc.film_id
                    INNER JOIN streaming.film_actor fa
...
AS film_info
FROM streaming.actor a
LEFT JOIN streaming.film_actor fa
  ON a.actor_id = fa.actor_id
LEFT JOIN streaming.film_category fc
  ON fa.film_id = fc.film_id
LEFT JOIN streaming.category c
